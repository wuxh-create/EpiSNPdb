<template>
    <div>
        <div class="content-container">
            <div class="home-search" style="margin: 20px 0; display: flex; justify-content: center;">
                <el-row class="row-bg" justify="center" align="middle" type="flex" style="width: 100%;">
                    <el-col :span="16" :offset="1">
                        <el-input 
                            v-model="input" 
                            placeholder="SNP ID, SNP Position, Epistasis-SNP or Cancer" 
                            class="search-input" 
                            ref="searchInput"
                        ...
                        >
                            <el-button 
                                ...
                                style="background-color: #87CEFA; color: black; border-radius: 0;height: 100%;font-size:18px;"
                            >
                            Search
                            </el-button>
                        </el-input>
                        <div class="input-examples" style="font-size: 17px; margin-top: 8px;margin-bottom: 0px; font-family: Helvetica;"> 
                            <span>Input examples: </span>
                            <span :class="{ 'selected': isSelected('rs12924101') }" @click="fillInputAndSearch('rs12924101')">rs12924101, </span>
                            <span :class="{ 'selected': isSelected('chr1:1003629-1003739') }" @click="fillInputAndSearch('chr1:1003629-1003739')">chr1:1003629-1003739, </span>
                            <span :class="{ 'selected': isSelected('rs6687430_rs17781327') }" @click="fillInputAndSearch('rs6687430_rs17781327')">rs6687430_rs17781327, </span>
                            <span :class="{ 'selected': isSelected('Breast') }" @click="fillInputAndSearch('Breast')">Breast</span>
                        </div>
                    </el-col>
                </el-row>
            </div>
            ...
            <div class="panel" style="margin-top: 2px;">
                <div class="panel-header" style="font-family: Helvetica;">
                    <span v-pre style="font-family: Helvetica;">
                        Welcome to the EpiSNP-db
                    </span>
                </div> 
                <div class="panel-body" >
                    <!-- <div style="height: 12px; width: 70%;"></div> -->
                    <div style="display: flex;">
                        <div style="width: 72%;font-family: Helvetica;">
                            ...
                            <div style="height: 8px; width: 72%;"></div>
                            <div style="display: flex;">
                                <div style="width: 100%;">
                                    <div class="text-section" style="font-family: Helvetica;text-align: justify;">
                        ...
                        <div style="width: 30%; margin-left: 15px;padding: 30px 10px 10px 0px; margin-top: 20px;">
                            <img src="home_epistasis.svg" alt="Image description" style="max-width: 100%; height: auto;">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="innerBody">
                                <el-table :data="showData" style="width: 100%">
                                    <el-table-column
                                        ...
                                        label="Category"
                                        width="143" 
                                        :header-cell-style="{ backgroundColor: '#F5DBCB', color: 'white',fontWeight: 'bold' }">
                                        <template slot-scope="scope">
                                            <span :style="{ color: getColor(scope.row.name),fontWeight: 'bold' }">{{ scope.row.name }}</span>
                                        </template>
                                    </el-table-column>
                                    <el-table-column
                                        prop="number"
                                        label="Total"
                                        width="126" 
                                        :header-cell-style="{ backgroundColor: '#004D40', color: 'white',fontWeight: 'bold' }">
                                        <template slot-scope="scope">
                                            <span :style="{ color: getColor(scope.row.number),fontWeight: 'bold' }">{{ scope.row.number }}</span>
                                        </template>
                                    </el-table-column>
                                </el-table>
...
export default {
    ...
    data() {
        return {
            ...
            showData: [
                ...
                { name: "GWAS loci", number: "173,172" },
                { name: "Interaction Pairs", number: "145,504" },
            ],
            chartTitles: [
            ...
            speciesList: [
                { name: 'Breast', image: 'Breast.png', descriptionLine1: 'Case=19,207', descriptionLine2: 'Control=161,999', descriptionLine3: 'epiSNPs=10,605', showDetails: false },
                { name: 'Prostate', image: 'Prostate.png', descriptionLine1: 'Case=14,466', descriptionLine2: 'Control=136,966', descriptionLine3: 'epiSNPs=11,461', showDetails: false },
                { name: 'Melanoma', image: 'Melanoma.png', descriptionLine1: 'Case=8,416', descriptionLine2: 'Control=298,965', descriptionLine3: 'epiSNPs=10,080', showDetails: false },
                { name: 'Colon', image: 'Colon.png', descriptionLine1: 'Case=6,834', descriptionLine2: 'Control=298,965', descriptionLine3: 'epiSNPs=9,718', showDetails: false },
                { name: 'Cervical', image: 'Cervical.png', descriptionLine1: 'Case=6,740', descriptionLine2: 'Control=161,999', descriptionLine3: 'epiSNPs=11,027', showDetails: false },
                { name: 'Lung', image: 'Lung.png', descriptionLine1: 'Case=4,960', descriptionLine2: 'Control=298,965', descriptionLine3: 'epiSNPs=10,970', showDetails: false },
                { name: 'Bladder', image: 'Bladder.png', descriptionLine1: 'Case=4,128', descriptionLine2: 'Control=298,965', descriptionLine3: 'epiSNPs=10,224', showDetails: false },
                { name: 'Rectal', image: 'Rectal.png', descriptionLine1: 'Case=3,142', descriptionLine2: 'Control=298,965', descriptionLine3: 'epiSNPs=10,470', showDetails: false },
                { name: 'Uterine', image: 'Uterine.png', descriptionLine1: 'Case=2,768', descriptionLine2: 'Control=161,999', descriptionLine3: 'epiSNPs=10,661', showDetails: false },
                { name: 'Kidney', image: 'Kidney.png', descriptionLine1: 'Case=2,314', descriptionLine2: 'Control=298,965', descriptionLine3: 'epiSNPs=10,841', showDetails: false },
                { name: 'Ovarian', image: 'Ovarian.png', descriptionLine1: 'Case=2,182', descriptionLine2: 'Control=161,999', descriptionLine3: 'epiSNPs=10,526', showDetails: false },
                { name: 'Pancreatic', image: 'Pancreatic.png', descriptionLine1: 'Case=1,668', descriptionLine2: 'Control=298,965', descriptionLine3: 'epiSNPs=10,681', showDetails: false },
                { name: 'Esophagus', image: 'Esophagus.png', descriptionLine1: 'Case=1,609', descriptionLine2: 'Control=298,965', descriptionLine3: 'epiSNPs=11,563', showDetails: false },
                { name: 'Stomach', image: 'Stomach.png', descriptionLine1: 'Case=1,305', descriptionLine2: 'Control=298,965', descriptionLine3: 'epiSNPs=11,369', showDetails: false },
                { name: 'Brain', image: 'Brain.png', descriptionLine1: 'Case=1,157', descriptionLine2: 'Control=298,965', descriptionLine3: 'epiSNPs=11,605', showDetails: false },
                { name: 'Liver', image: 'Liver.png', descriptionLine1: 'Case=1,122', descriptionLine2: 'Control=298,965', descriptionLine3: 'epiSNPs=11,371', showDetails: false },
            ]
        }
    },
    methods: {
        fillInputAndSearch(example) {
            this.input = example;
            this.quickSearch();
        },
        pauseCarousel() {
        ...
        getColor(value) {
            ...
            if (value === 'Cancer samples' || value === '82,018') return '#3F51B5';
            if (value === 'GWAS loci' || value === '173,172') return '#9B59B6';
            if (value === 'Interaction Pairs' || value === '145,504') return '#D9386D';
            return 'black';
        },
        ...
        interactionNumPlot() {
            ...
            this.chartInteraction.setOption({
                ...
                series: [
                    {
                        data: [6840,7717,7079,6347,18207,17227,7019,7421,7588,7870,7556,8221,8880,8976,9294,9262],
                        type: "bar",
                        barWidth: '30%',
                        barCategoryGap: '10%',   
                        itemStyle: {
    ...
    mounted() {
        ...
        this.$nextTick(() => {
            this.$refs.searchInput.$el.querySelector('.el-input__inner').style.fontSize = '15px';
        });
    }
}
</script>
...
.search-input .el-button {
    ...
    font-size: 10px; /* Make the input text larger */
