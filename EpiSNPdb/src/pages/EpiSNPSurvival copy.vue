      ...
      <el-row class="custom-row" :style="{ marginBottom: '15px' }">
        <el-col :span="24">
            <p class="card-description" style="font-size: 18px; line-height: 1.7; font-family: 'Helvetica';">
              This module provides survival results of epiSNPs. We have conducted KM analysis to identify survival related epiSNPs using additive, dominant, and recessive models, respectively. And <span style="color: blue; font-weight: bold;">38,313</span> significant SNP epistases with a P-value < 1e-5 have been found.
            </p>
        </el-col>
      </el-row>
      ...
      <div>
        <el-row :gutter="20" type="flex" justify="center">
          ...
          <el-col :span="5" v-if="selectQueryType === 'Cancer Type'">
            ...
            <el-select v-model="selectLociType" placeholder="Select Loci" class="place-input loci-type-select" style="width: 100%; font-size: 17px;">
          ...
          <el-col :span="5" v-if="selectQueryType === 'SNP Epistasis'">
            ...
            <span :class="{ 'text-black': !isClicked2, 'text-orange': isClicked2 }" @click="handleClickAndSetQueryRsid2" style="font-size: 16px;">e.g., rs12407887_rs118047432</span>
          </el-col>
          <!-- Model select -->
          <el-col :span="5">
    ...
    <el-card class="box-card">
      ...
      <el-table :data="QTLData.SnpEpistasis" style="width: 100%;" empty-text="No results found for your query">
        <el-table-column
          ...
          width="60"
          align="center"
          class-name="custom-column-header"
        >
...
methods: {
  ...
  displayDataBasedOnModel() {
      if (this.selectQueryType === 'Cancer Type' && this.selectLociType === 'SNP Epistasis') {
          ...
          const displayColumns = [
              ...
              { prop: "OS_Median_AABb_and_AAbb", label: "OS_Median_AABb_and_AAbb", width: 200,format: 'decimal' },
              { prop: "OS_Median_AaBB_and_aaBB", label: "OS_Median_AaBB_and_aaBB", width: 200,format: 'decimal' },
              { prop: "OS_Median_AaBb_Aabb_aaBb_and_aabb", label: "OS_Median_AaBb_Aabb_aaBb_and_aabb", width: 250,format: 'decimal' }
          ];
          ...
          const displayColumns = [
              ...
              { prop: "OS_Median_AA", label: "OS_Median_AA", width: 155,format: 'decimal' },
  ...
  //   sanitizedQueryRsid1 = this.valueCheck(sanitizedQueryRsid1);
  //   if (sanitizedQueryRsid1 === null) {
  //     this.loading = false;
  //     return; // 中断表单提交
  //   }
  ...
  //     snp: sanitizedQueryRsid1,
  //     page: this.currentPage,
  //     pageSize: this.perPage
  //   };

  //   console.log("Query parameters being sent to Flask backend:", queryParams);
  ...
  submitForm() {
    ...
    if (this.selectQueryType === 'SNP' || sanitizedQueryRsid1.match(/^rs[0-9]+$/)) {
      apiUrl = 'api/SnpSurvival';
    } else if (this.selectQueryType === 'SNP Epistasis' || sanitizedQueryRsid1.match(/^rs[0-9]+_rs[0-9]+$/)) {
      apiUrl = 'api/SnpEpistasisSurvival';
    } else if (this.selectQueryType === 'Cancer Type' && this.selectLociType === 'SNP') {
      apiUrl = 'api/SnpCancerTypeSurvival';
    } else if (this.selectQueryType === 'Cancer Type' && this.selectLociType === 'SNP Epistasis') {
