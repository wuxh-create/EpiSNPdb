    ...
    <div>
        <div @click="closeAlert">
            ...
            <div class="content-container">
                <el-row>
                    <!-- 左边的查询搜索框 -->
                    <el-col :span="6" class="search-container" style="display: flex; flex-direction: column; justify-content: center; align-items: center; height: 60%; margin-top: 50px;">
                        <!-- 查询搜索框内容 -->
                        <span class="input-label" style="align-self: flex-start; margin-left: 10%;">Query Epistasis:</span>
                        <el-input placeholder="Search Epistasis" v-model="queryRsid1" clearable style="margin-bottom: 10px; width: 80%;"></el-input>
                        <span :class="{ 'text-black': !isClicked1, 'text-orange': isClicked1 }" @click="handleClickAndSetQueryRsid1" 
                        style="font-size: 17px;align-self: flex-start; margin-left: 10%;">e.g., rs10009280</span>
                        <span :class="{ 'text-black': !isClicked2, 'text-orange': isClicked2 }" @click="handleClickAndSetQueryRsid2" 
                        style="font-size: 17px;align-self: flex-start; margin-left: 10%;">e.g., rs10009280_rs117969794</span>
                        <div style="display: flex; justify-content: space-between; width: 80%;">
                            <el-button type="primary" class="submit-button" style="display: flex; align-items: center; justify-content: center;margin-top: 15px;" @click="handleSearch">Submit</el-button>
                            <el-button type="danger" class="cancel-button" style="display: flex; align-items: center; justify-content: center;margin-top: 15px;" @click="clearInput">Cancel</el-button>
                        </div>
                    </el-col>
                    ...
                    <el-table
                        ...
                        <el-table-column prop="alleles1" label="Sample" width="78" align="center" class="custom-column-header">
                            <template v-slot="scope">
                                ...
                                style="font-size: 1.8em; cursor: pointer; color: #AED4D4;" />
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column prop="ORstatus" label="OR plot" width="82" align="center" class="custom-column-header">
                            <template v-slot="scope">
                                <a-icon type="bar-chart" theme="outlined"
                                    ...
                                    :style="{ fontSize: '1.8em', cursor: 'pointer', color: scope.row.ORstatus ? 'blue' : 'grey' }"
                                />
                            </template>
                        </el-table-column>
                            ...
                            <template v-slot="scope">
                                <div class="stars-container">
                                    <el-tooltip content="epistasis" placement="top">
                                        <i class="el-icon-star-on" :class="{ 'star-yellow': scope.row.Isepistasis, 'star-gray': !scope.row.Isepistasis }" style="font-size: 22px;"></i>
                                    </el-tooltip>
                                    <el-tooltip content="joint" placement="top">
                                        <i class="el-icon-star-on" :class="{ 'star-yellow': scope.row.Isjoint, 'star-gray': !scope.row.Isjoint }" style="font-size: 22px;"></i>
                                    </el-tooltip>
                                    <el-tooltip content="boost" placement="top">
                                        <i class="el-icon-star-on" :class="{ 'star-yellow': scope.row.Isboost, 'star-gray': !scope.row.Isboost }" style="font-size: 22px;"></i>
                                    </el-tooltip>
                                </div>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column
                            ...
                            <template v-slot="scope">
                                <span
                                    :style="{
                                        color: 'red',
                                        fontSize: cancerTypes.includes(scope.row.Cancertype) ? '1em' : 'inherit'
                                    }"
                                >
    ...
    export default {
        ...
        methods: {
            ...
            handleClickAndSetQueryRsid1() {
                this.setQueryRsid1('rs10009280');
                this.isClicked1 = true;
                this.isClicked2 = false;
            },
            handleClickAndSetQueryRsid2() {
                this.setQueryRsid1('rs10009280_rs117969794');
            ...
            QuickCancerinteresting() {
                this.loading = true;
                let queryParams = {
                    queryRsid1: this.queryRsid1 || 'defaultRsid', 
                    cancertype: this.speciesName || this.$route.params.speciesName || this.$route.params.queryID, 
                };
                axios.get('api/QuickCancerinteresting', { params: queryParams })
                    .then(response => {
                        this.snpEpiTableData = response.data.SNPEpiTable;
                        this.snpEpiNetworkData = response.data.SNPEpiNetwork;
                        this.snpGWASData = response.data.CancerGWAS;
