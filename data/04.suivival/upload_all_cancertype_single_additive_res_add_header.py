...
input_file_path = '/home/wuxh/SSIdb3/data/04.suivival/all_cancertype_single_additive_res_add_header_filter_p_0.05_remove_na_add_example_tag'
collection_name = 'SingleAdditiveSurvival'  # 在 MongoDB 中显示的表格名称
# 定义导入功能
